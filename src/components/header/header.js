...
export const Header = () => {
    ...
    return (
        <>
            ...
            <div className="w-full min-h-[7vh]  justify-between  flex items-center lg:text-[28px] sm:text-base font-medium  lg:pr-[125px] lg:pl-[125px] sm:pl-[2px] sm:pr-[8px]">
                ...
                <div className="flex shrink-0 gap-[15px]">
                    ...
                    {!showProfile? <AccountCircleIcon/>: <ClearSharpIcon/>}
                    </button>
                    <button
